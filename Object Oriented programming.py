...
#     def change_firstname(self,first_name):
#         self.first_name = first_name
#
# emp_1 = Employee("Uche","Joseph",1000000)
# emp_2 = Employee("Charles","Kelvin", 500000)
# print(emp_1.get_firstname())
# emp_1.change_firstname("Olisa")
# print(emp_1.get_firstname())
